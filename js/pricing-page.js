...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    events: [
      {
        title: '<div class="pricing_wrapper"><div class="pricing_event"><h6>50 AED</h6><p>10:00 am - 11:00 pm</p></div>  <div class="event-btns"><a class="btn btn-sm btn-cancel radius-rounded"> <img src="images/cancel.svg" alt="Cancel"> <span>Delete</span> </a> </div></div>',
